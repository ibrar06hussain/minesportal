            ...
            <div class="col-md-12">
                <div class="card p-2">
                    ...
                    <!-- progressbar -->
                        ...
                        <div class="progress">
                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width: 40%" aria-valuenow="40" >
                            <span id="progressValue">40%</span>
                            </div>
                        </div> <br> <!-- fieldsets -->
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="form-class col-md-10 text-right">
                            <div class="container">
                        <!-- THIS IS END OF BEGINNING COORDINATES -->
                       ...
                       <div class="container ">
                           <!-- Map Section -->
                                ...
                                <div class="seven">
                                   ...
                                   <div class="col-md-4">
                                       <div class="card shadow-sm mt-4 mb-4" style="height: 400px;">
                                           <div class="card-body">
                                               <span class="card-title text-info">Overlap Information:</span>
                               ...
                               <div class="row">
                                       ...
                                       <div class="card shadow-sm mb-4">
                                           <div class="card-body">
                                               ...
                                               <div class="d-flex justify-content-between mt-3">
                                                <div class="text-left">
                                                   <button id="check-overlap" class="next action-button">Check Overlap</button>
                                                </div>
                                                <div class="text-right">
                                                   <button id="exitButton"  class="next action-button">Exit</button>
                                                   <button id="saveButton"  class="next action-button" value="Next">Save & Next</button>
                                                </div>
                                               </div>
                                           </div>
                                       </div>
                                   ...
                                   <hr class="invis" />
                                   <!-- THIS IS END OF ADD COORDINATES -->
                            </div>
                             <div class="col-md-1"></div>
                        </div>
                    </div>
            ...
            if (overlapResults.length > 0) {
              ...
              hasOverlap=true;
                 ...
                 // Get the table body element
                        ...
                        statusMessage.html('No overlap found. You can save the coordinates by clicking next.')
    ...
    const saveCoordinate = document.getElementById('saveButton');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                window.location.href = '/new_applications/generate_challans/' + appid;
