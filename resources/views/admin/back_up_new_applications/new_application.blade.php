                ...
                <form id="registrationform" action="{{ route('new_applications.new_application_store') }}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input id="name_mineral" type="text" name="name_mineral" value="{{ old('name_mineral') }}" class="form-control @error('name_mineral') is-invalid @enderror"  placeholder="Enter Name of Mineral for which title is required" fdprocessedid="z92vz">
                            @error('name_mineral')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="location" type="text" name="location" value="{{ old('location') }}" class="form-control @error('location') is-invalid @enderror"  placeholder="Enter your Location" fdprocessedid="9045rq">
                            @error('location')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <input id="covered_area" type="text" name="covered_area" value="{{ old('covered_area') }}" class="form-control @error('covered_area') is-invalid @enderror" placeholder="Enter your Covered Area" fdprocessedid="mn6ilc">
                            @error('covered_area')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
