...
<body>
    ...
    <h1>Dear User,</h1>
    <p>Greetings from Mines & Minerals Department. Please verify your account by clicking the link given below.</p>
    <div>
        <a href="{{route('verification',['token'=>$encodedEmail])}}">{{route('verification',['token'=>$encodedEmail])}}</a>
    </div>
</body>
</html>
